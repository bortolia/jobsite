...
?>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://bortolia.myweb.cs.uwindsor.ca/60334/project/html/signin.php">Sign In</a>
          </li>
          <li class="nav-item">
    ...
    <main role="main" class="container">
      <div class="row">
      <div class="col-12">
        <form class="form-signin text-center" action="what_good.php" method="post">
